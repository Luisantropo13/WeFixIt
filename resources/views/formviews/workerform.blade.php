    ...
    <form action="{{route('addWorker')}}" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="form-check form-check-inline">
                <input name="workerPlace" class="form-check-input" type="checkbox" value="option1">
                <label class="form-check-label" for="inlineCheckbox1">Admin</label>
            </div>
            <div class="form-check form-check-inline">
                <input name="workerPlace" class="form-check-input" type="checkbox" value="option2">
                <label class="form-check-label" for="inlineCheckbox1">Network Installer</label>
            </div>
            <div class="form-check form-check-inline">
                <input name="workerPlace" class="form-check-input" type="checkbox" value="option3">
                <label class="form-check-label" for="inlineCheckbox2">Advisor</label>
            </div>
            <div class="form-check form-check-inline">
                <input name="workerPlace" class="form-check-input" type="checkbox" value="option4">
