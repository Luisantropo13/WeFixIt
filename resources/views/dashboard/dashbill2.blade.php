    ...
    <table class="table" style="width:80vw; margin-left:-50px;">
        <thead>
            <tr>
                ...
                <th scope="col"> </th>
                <th scope="col"><a href="{{ route('billFormAdd2')}}" class="btn btn-success">Add</a></th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td><a href="/billDashWork/modread?billId={{$bill->billId}}" class="btn btn-warning">Modify</a></td>
                <td><a onclick="return confirm('Seguro que quiere borrar?')" href="/billDashWork/delete?billId={{$bill->billId}}" class="btn btn-danger">Delete</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
